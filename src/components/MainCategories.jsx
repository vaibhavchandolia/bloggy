...
const MainCategories = () => {
  return (
    <div className='Hidden md:flex bg-white rounded-3xl xl:rounded-full p-4 shadow items-center justify-center gap-8'>
        {/* links */}
        ...
        {/* search */}
        <div className="bg-gray-100 p-2 rounded-full items-center gap-2 flex">
            <svg
